...
2. 查阅 `docs/20-engineering/doc-update-matrix.md`
3. 在同一轮变更中同步更新：
   - 代码
   - 文档
   - 测试
...
6. 运行 `infra/scripts/release-check.sh`
7. 确认仓库没有构建产物、系统垃圾文件和无效脚手架残留
...
详细映射见 `docs/20-engineering/doc-update-matrix.md`。
...
## 规范补充机制
规范不是一次写死，新增或修正规则时按 `docs/20-engineering/spec-lifecycle.md` 执行。
